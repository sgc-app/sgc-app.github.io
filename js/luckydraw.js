(function($) {
    ...
    var waitInterval;
    var machineImage = "../images/sgc-machine.png";
    var backgroundAudio = "../music/sgc-music.mp3";
    var balls;
    var draw = function() {};
    var pause = true;
    var callback;
    ...
    var methods = {
        init: function(settings) {
			jsFileLocation = $('script[src*=luckydraw]').attr('src');  // the js file path
			sFileLocation = jsFileLocation.replace(/luckydraw.*\.js.*$/, '');   // the js folder path
            ...
            img1.src = sFileLocation + "../images/sgc-bingo.png";
            var img2 = new Image();
            img2.onload = onloadCallback;
            img2.src = sFileLocation + "../images/sgc-bingo.png";
            var img3 = new Image();
            img3.onload = onloadCallback;
            img3.src = sFileLocation + "../images/sgc-bingo.png";
            var img4 = new Image();
            img4.onload = onloadCallback;
            img4.src = sFileLocation + "../images/sgc-bingo.png";
            var img5 = new Image();
            img5.onload = onloadCallback;
            img5.src = sFileLocation + "../images/sgc-bingo.png";
            var img6 = new Image();
            img6.onload = onloadCallback;
            img6.src = sFileLocation + "../images/sgc-bingo.png";
            var img7 = new Image();
            img7.onload = onloadCallback;
            img7.src = sFileLocation + "../images/sgc-bingo.png";
            var img8 = new Image();
            img8.onload = onloadCallback;
            img8.src = sFileLocation + "../images/sgc-bingo.png";
            var img9 = new Image();
            img9.onload = onloadCallback;
            img9.src = sFileLocation + "../images/sgc-bingo.png";
            var img0 = new Image();
            img0.onload = onloadCallback;
            img0.src = sFileLocation + "../images/sgc-bingo.png";

            var tube = new Image();
            tube.onload = onloadCallback;
            tube.src = sFileLocation + "../images/sgc-tube.png";
            ...
            $(this).append('</br>');
            $(this).append('<canvas id="myCanvas2"></canvas>');
            ...
            canvas2.width = (containerR / 5 * 2 + 10) * 7; // change here: phone number = 10, customer code = 7
        ...
        run: function(numbers) {
            // change here: phone number = 10, customer code = 7
            for (i = 0; i < 7; i++) {
                balls[i].picked = 0;
            }
            resetPicked = true;
            ...
            setTimeout(function() {
                ...
                setTimeout(function() {
                    balls[digits[4]].picked = 5;
                }, waitInterval * 10);
                setTimeout(function() {
                    balls[digits[5]].picked = 6;
                }, waitInterval * 12);
                // setTimeout(function() {
                //     balls[digits[6]].picked = 7;
                // }, waitInterval * 14);
                // setTimeout(function() {
                //     balls[digits[7]].picked = 8;
                // }, waitInterval * 16);
                // setTimeout(function() {
                //     balls[digits[8]].picked = 9;
                // }, waitInterval * 18);

                setTimeout(function() {
                    balls[digits[6]].picked = 7; // change here: phone number => 9 and 10, customer code => 6 and 7
                ...
                }, waitInterval * 14); // change here: phone number = 20, customer code = 14
